...
export default function CreatePost() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      alert('Please fill proper details and generate an image.');
    }
  };
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
            <p>Once you have created the image your want, you can share it with others in the community</p>
            <button
              type='submit'
